    ...
    <div class="page-card overflow-hidden mb-6">
        ...
        <div class="flex px-6" style="border-bottom: 1px solid var(--divider)">
            ...
            <button @click="tab = 'delete'"
                    class="px-4 py-3.5 text-sm font-medium border-b-2 transition-colors -mb-px hidden"
        ...
        <div x-show="tab === 'delete'" style="display:none;"
            ...
            <form action="{{ route('profile.destroy') }}" method="POST" class="px-8 py-7 space-y-6"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password"
                               class="w-full pl-10 pr-4 py-2.5 rounded-xl input-theme outline-none text-sm transition @error('password') ring-2 ring-red-400 @enderror"
                ...
                <div class="flex justify-end pt-2">
                    <button type="submit"
                            class="inline-flex items-center gap-2 bg-red-600 hover:bg-red-500 text-white font-semibold py-2.5 px-6 rounded-xl transition shadow-lg shadow-red-500/20">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                        Hapus Akun Saya
                    </button>
                </div>
