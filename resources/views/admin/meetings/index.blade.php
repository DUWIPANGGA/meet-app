                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center justify-end gap-2">
                                ...
                                @if($m->tipe_rapat === 'Online')
                                <a href="{{ route('meeting.room', $m->id) }}" target="_blank" class="p-2 rounded-lg hover:bg-[var(--nav-link-hover)] transition" title="Masuk Rapat">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="color:#10b981"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg>
                                </a>
                                @endif
