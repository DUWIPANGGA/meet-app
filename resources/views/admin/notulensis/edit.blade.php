...
<div x-data="adminNotulensiShare()">
    ...
    <div class="card p-6 mb-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <button type="button" @click="openShareModal({{ $notulensi->meeting_id }}, {{ $notulensi->id }}, '{{ addslashes($notulensi->meeting?->nama_rapat ?? '') }}', '{{ $notulensi->akses_notulensi }}', {{ Js::from($notulensi->accessUsers->pluck('id')) }})"
