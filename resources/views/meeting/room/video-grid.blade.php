            <div id="videoGridWrapper"
                class="h-full overflow-hidden relative flex flex-row video-grid-container m-1 md:m-2">
                ...
                <div id="videoGridMain" class="min-w-0 relative z-0 h-full" style="flex:1">
                    <!-- Local Video -->
                    <div id="localVideoContainer" class="relative rounded-lg overflow-hidden w-full h-full video-card m-1">
                        <video id="localVideo" autoplay muted playsinline
                            style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;transform:scaleX(-1)"></video>
                        <div id="localAvatar" class="flex items-center justify-center hidden z-10"
